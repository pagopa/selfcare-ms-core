...
class MigrationInstitutionMapperCustomTest {
    ...
    /**
     * Method under test: {@link InstitutionMapperCustom#toInstitutionResponse(Institution)}
     */
    @Test
    void testToInstitutionResponse() {
        InstitutionResponse actualToInstitutionResponseResult = InstitutionMapperCustom.toInstitutionResponse(new Institution());
    ...
    void testToInstitutionResponse2() {
        InstitutionResponse actualToInstitutionResponseResult = InstitutionMapperCustom
    ...
    void testToInstitutionResponse3() {
        InstitutionResponse actualToInstitutionResponseResult = InstitutionMapperCustom
                .toInstitutionResponse(InstitutionMapperCustom.toInstitution(new InstitutionRequest(), "42"));
        assertNull(actualToInstitutionResponseResult.getAddress());
        assertFalse(actualToInstitutionResponseResult.isImported());
        assertNull(actualToInstitutionResponseResult.getZipCode());
        assertNull(actualToInstitutionResponseResult.getTaxCode());
    ...
    void testToInstitutionResponse7() {
        ...
        InstitutionResponse actualToInstitutionResponseResult = InstitutionMapperCustom.toInstitutionResponse(institution);
        assertNull(actualToInstitutionResponseResult.getAddress());
        assertFalse(actualToInstitutionResponseResult.isImported());
        assertNull(actualToInstitutionResponseResult.getZipCode());
        assertNull(actualToInstitutionResponseResult.getTaxCode());
    ...
    /**
     * Method under test: {@link InstitutionMapperCustom#toInstitutionResponseList(List)}
     */
    @Test
    void testToInstitutionResponseList() {
        assertTrue(InstitutionMapperCustom.toInstitutionResponseList(new ArrayList<>()).isEmpty());
    }
    ...
    void testToInstitutionResponseList2() {
        ...
        assertEquals(11, InstitutionMapperCustom.toInstitutionResponseList(institutionList).size());
    }
