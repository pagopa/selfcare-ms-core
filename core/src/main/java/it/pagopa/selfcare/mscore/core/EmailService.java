...
public class EmailService {
    ...
    public void sendMail(File pdf, Institution institution, User user, OnboardingRequest request, boolean isApprove) {
        List<String> destinationMail;
        Map<String, String> mailParameters;
        if (InstitutionType.PA == institution.getInstitutionType() || isApprove) {
