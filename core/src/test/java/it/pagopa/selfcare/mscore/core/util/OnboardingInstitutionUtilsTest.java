...
class OnboardingInstitutionUtilsTest {
    ...
    /**
     * Method under test: {@link OnboardingInstitutionUtils#constructBinding(UserToOnboard, OnboardingRequest, String)}
     */
    @Test
    void testConstructBinding() {
        UserToOnboard userToOnboard = new UserToOnboard();
        userToOnboard.setEmail("jane.doe@example.org");
        userToOnboard.setEnv(EnvEnum.ROOT);
        userToOnboard.setId("42");
        ...
        onboardingRequest.setSignContract(true);
        onboardingRequest.setUsers(new ArrayList<>());
        UserBinding actualConstructBindingResult = OnboardingInstitutionUtils.constructBinding(userToOnboard,
                onboardingRequest, "42");
        assertEquals(1, actualConstructBindingResult.getProducts().size());
        assertEquals("42", actualConstructBindingResult.getInstitutionId());
    }
    ...
    void testGetValidManager5() {
        ...
        ArrayList<OnboardedUser> onboardedUserList = new ArrayList<>();
        onboardedUserList.add(onboardedUser);
        List<String> actualValidManager = OnboardingInstitutionUtils.getValidManager(onboardedUserList, "42", "42");
        assertEquals(1, actualValidManager.size());
        assertNull(actualValidManager.get(0));
    }
    ...
    void testGetValidManager6() {
        UserBinding userBinding = new UserBinding();
        userBinding.setCreatedAt(null);
        userBinding.setInstitutionId("START - getValidManager for users list size: {}");
        userBinding.setProducts(new ArrayList<>());
    ...
    void testGetValidManager7() {
        ...
        userBinding1.setCreatedAt(null);
        userBinding1.setInstitutionId("Institution Id");
        userBinding1.setProducts(new ArrayList<>());
